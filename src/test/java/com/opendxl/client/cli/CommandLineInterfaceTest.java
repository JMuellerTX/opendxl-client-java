...
public class CommandLineInterfaceTest {
    ...
    private static final String PROVISION_USAGE = String.format(Locale.ROOT,
            "Usage: java -jar dxlclient-all.jar provisionconfig [-hV] [--insecure]%n"
                  +  "                                                   [--verbose]%n"
                  +  "                                                   [--country=COUNTRY]%n"
                  ...
                  +  "      --insecure             Do not validate the management server's certificate at%n"
                  +  "                               all (not recommended; use -e with the server's CA%n"
                  +  "                               instead)%n"
                  +  "      --key-bits=BITS        RSA key size in bits: 2048 (default), 3072 or 4096%n"
                  ...
                  +  "                             File with one or more PEM CA certificates used to%n"
                  +  "                               validate the management server's certificate (for a%n"
                  +  "                               certificate issued by a private CA, e.g. the ePO%n"
                  +  "                               server CA). Without this option the certificate is%n"
                  +  "                               validated against the JVM's trusted CAs.%n"
    ...
    private static final String UPDATE_CONFIG_USAGE = String.format(Locale.ROOT,
            "Usage: java -jar dxlclient-all.jar updateconfig [-hV] [--insecure] [--verbose]%n"
                  +  "                                                [-e=TRUSTSTORE_FILE]%n"
                  +  "                                                [-p=PASSWORD] [-t=PORT]%n"
